...
export function ModuleLayout({ app, children }: ModuleLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50">
      ...
      >
        <header className="hidden border-b border-white/10 bg-white/5 backdrop-blur-xl xl:block">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-4 lg:px-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs tracking-[0.32em] text-slate-400 uppercase">Module</div>
        ...
        <main className="mx-auto max-w-7xl px-0 py-0 xl:px-6 xl:py-6">
          <section
            className={cn(
              'rounded-[2rem] border border-white/10 p-5 shadow-2xl shadow-black/20 backdrop-blur-xl xl:p-6',
              app.kind === 'admin'
          ...
          >
            <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
              <div>
                ...
                <h2 className="mt-4 text-2xl font-semibold text-white xl:text-3xl">
                  {app.description}
                </h2>
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {app.highlights.map((item) => (
                      <span
                        key={item}
                        className="rounded-full bg-white/8 px-3 py-1.5 text-sm text-slate-100"
                      >
                        {item}
                      </span>
                    ))}
